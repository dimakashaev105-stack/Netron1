...
💵 *За доставку:* {level_data['pay']}❄️ + бонус
...
💰 *За эту доставку:* {total_pay}❄️
🏆 *Заработано за смену:* {job['earnings']}❄️
...
💰 *Всего заработано:* {format_balance(stats['earned'])}❄️
...
"""
            ...
            if job["earnings"] > 0:
                msg += f"""
💰 *Заработано:* {format_balance(job['earnings'])}❄️
📦 *Доставок:* {job['done']}
"""
