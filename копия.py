    ...
    try:
        if call.data == "mining_collect":
            ...
            if accumulated_trees > 0:
                ...
                cursor.execute(
                    'UPDATE users SET mining_balance = ?, last_mining_collect = ?, mining_trees = mining_trees + ? WHERE user_id = ?',
            ...
            if balance >= card_price:
                ...
                mining_balance = cursor.fetchone()[0]
...
def handle_me(message):
    try:
        ...
        cursor.execute('''
            SELECT first_name, video_cards, bank_deposit, last_mining_collect, registered_at, mining_balance, nickname 
        ...
        if result:
            first_name, video_cards, bank_deposit, last_mining_collect, registered_at, mining_balance, nickname = result
